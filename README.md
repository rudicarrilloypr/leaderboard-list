...
**Leaderboard App** project for the Leaderboard list app, using webpack and ES6 features, notably modules.. This README file provides an overview of the project and explains how to set it up and run it on your local machine.
